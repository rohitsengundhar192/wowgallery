...
const baseURL = 'https://u21api.getwow.community/api/';
...
export const environment = {
  ...
  //Api's
  // parent_child_select:baseURL+ 'cloud-file-storage/parent-student-linkage/get-selected-studentonly-by-user-id',
  //Institutional Images/Videos Api's
  //Dialogue
  ...
  getlaunch:
    baseURL + 'cloud-file-storage/parent-student-linkage/launch-screen-display',
  getalldatascreendefault:
    baseURL +
    'cloud-file-storage/parent-student-linkage/get-all-data-screen-default',

  getenablestatuscount:
    baseURL +
    'cloud-file-storage/parent-student-linkage/get-enable-status-count',
  getenablestatuscountdefault:
    baseURL +
    'cloud-file-storage/parent-student-linkage/get-enable-status-count-default',
  cloudidpost:
    baseURL +
    'cloud-file-storage/parent-student-linkage/launch-screen-display-cloud-id-post',
  getuploadedimagespost:
    baseURL +
    'cloud-file-storage/parent-student-linkage/get-uploaded-image-post',
  // ------------------------------- CEPH Storage -----------------
