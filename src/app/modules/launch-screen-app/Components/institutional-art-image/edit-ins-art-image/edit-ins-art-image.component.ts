...
@Component({
  selector: 'app-edit-ins-art-image',
  templateUrl: './edit-ins-art-image.component.html',
  styleUrls: ['./edit-ins-art-image.component.scss'],
})
export class EditInsArtImageComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* ---------------------------  Constructor  ----------------------------*//
  constructor(
    public loginDialogRef: MatDialogRef<EditInsArtImageComponent>,
    ...
    public MatDialogRef: MatDialogRef<EditInsArtImageComponent>,
