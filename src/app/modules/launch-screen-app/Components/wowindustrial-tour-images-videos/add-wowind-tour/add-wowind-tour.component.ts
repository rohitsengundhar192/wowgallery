...
@Component({
  selector: 'app-add-wowind-tour',
  templateUrl: './add-wowind-tour.component.html',
  styleUrls: ['./add-wowind-tour.component.scss'],
})
export class AddWowindTourComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* ---------------------------  Constructor  ----------------------------*//
  constructor(
    public loginDialogRef: MatDialogRef<AddWowindTourComponent>,
    ...
    public MatDialogRef: MatDialogRef<AddWowindTourComponent>,
  ...
  images: any;
  searchWords: any; //* --------------------------  Public methods  --------------------------*//
  cantegory_name: any;
