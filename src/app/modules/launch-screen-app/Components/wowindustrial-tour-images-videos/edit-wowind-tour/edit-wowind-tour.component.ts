...
@Component({
  selector: 'app-edit-wowind-tour',
  templateUrl: './edit-wowind-tour.component.html',
  styleUrls: ['./edit-wowind-tour.component.scss'],
})
export class EditWowindTourComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* ---------------------------  Constructor  ----------------------------*//
  constructor(
    public loginDialogRef: MatDialogRef<EditWowindTourComponent>,
    ...
    public MatDialogRef: MatDialogRef<EditWowindTourComponent>,
