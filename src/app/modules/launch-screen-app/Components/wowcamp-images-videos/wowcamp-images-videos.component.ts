...
import { AddWowcampImagesVideosComponent } from './add-wowcamp-images-videos/add-wowcamp-images-videos.component';
import { EditWowcampImagesVideosComponent } from './edit-wowcamp-images-videos/edit-wowcamp-images-videos.component';
...
@Component({
  selector: 'app-wowcamp-images-videos',
  templateUrl: './wowcamp-images-videos.component.html',
  styleUrls: ['./wowcamp-images-videos.component.scss'],
})
export class WowcampImagesVideosComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  gallery_file_category: number = 2;
  ...
  //* -------------------------  Lifecycle Hooks  --------------------------*//
  ngOnInit() {
    this._headertitle.setTitle(`WOW Camp Images / Videos`);
  ...
  enablewowscreen() {
    ...
    this._apiservice.updateenableforwowscreenimgvid(body).subscribe((res) => {
      ...
      '<html><head>' +
        ...
        <style>
          ...
          <div style=" display: flex;flex-direction: column; width:100%">
            ...
            <span style="text-align: center;font-size:16px;color:black;font-weight:600;text-transform: uppercase">WOW Camp Images / Videos</span>
  ...
  //open dialogue
  openDialog() {
    const dialogRef = this.dialog.open(AddWowcampImagesVideosComponent, {
      disableClose: true,
      height: '90%',
      minWidth: '250px',
      width: '580px',
  ...
  edit(): void {
    const dialogRef = this.dialog.open(EditWowcampImagesVideosComponent, {
      disableClose: true,
      // minWidth: '250px',
      height: '90%',
      width: '560px',
