...
@Component({
  selector: 'app-add-wowcamp-images-videos',
  templateUrl: './add-wowcamp-images-videos.component.html',
  styleUrls: ['./add-wowcamp-images-videos.component.scss'],
})
export class AddWowcampImagesVideosComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* ---------------------------  Constructor  ----------------------------*//
  constructor(
    public loginDialogRef: MatDialogRef<AddWowcampImagesVideosComponent>,
    ...
    public MatDialogRef: MatDialogRef<AddWowcampImagesVideosComponent>,
  ...
  getCustomerProfileUrl(ceph_object_id: string) {
    let profileUrl = environment.ceph_URL + this.country_code+'-'+this.customer_id+'/'+ceph_object_id;
    return profileUrl;
  }
