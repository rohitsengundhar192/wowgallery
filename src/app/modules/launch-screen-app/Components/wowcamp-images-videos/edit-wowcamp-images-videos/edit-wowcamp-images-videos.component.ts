...
@Component({
  selector: 'app-edit-wowcamp-images-videos',
  templateUrl: './edit-wowcamp-images-videos.component.html',
  styleUrls: ['./edit-wowcamp-images-videos.component.scss'],
})
export class EditWowcampImagesVideosComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* ---------------------------  Constructor  ----------------------------*//
  constructor(
    public loginDialogRef: MatDialogRef<EditWowcampImagesVideosComponent>,
    ...
    public MatDialogRef: MatDialogRef<EditWowcampImagesVideosComponent>,
    ...
    if (this.checkfile == 1) {
      ...
      let body: any = {
        ...
        gallery_file_upload_id:
          this.gallery_file_upload_id || this.gallery_file_upload_id_image,
        tagged_user_id: pushhh,
        ...this.flr_user(),
        video_duration_in_sec: this.duration,
      };
