...
export class LaunchScreenAppComponent implements OnInit, OnDestroy {
  ...
  menu = [
    {
      label: 'Institutional Photos / Videos',
      link: '/launch-screen/instutional-photos-videos',
    },
    // {
    //   label: 'Institutional Art / Images',
    //   link: '/launch-screen/institutional-art-image',
    // },
    {
      label: 'WOW Camp Images / Videos',
      link: '/launch-screen/wowcamp-images-videos',
    },
    {
      label: 'WOW Industrial Tour Images / Videos',
      link: '/launch-screen/wowindustrial-tour-images-videos',
    },
    {
      label: 'GETster Screen Default Images / Videos',
      link: '/launch-screen/wowscreen-defualt-images-videos',
    },
