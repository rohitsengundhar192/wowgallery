...
@Component({
  selector: 'app-wowcamp-images-videos-popup',
  templateUrl: './wowcamp-images-videos-popup.component.html',
  styleUrls: ['./wowcamp-images-videos-popup.component.scss']
})
export class WowcampImagesVideosPopupComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* ---------------------------  Constructor  ----------------------------*//
  constructor(
    public loginDialogRef: MatDialogRef<WowcampImagesVideosPopupComponent>,
    ...
    public MatDialogRef: MatDialogRef<WowcampImagesVideosPopupComponent>,
